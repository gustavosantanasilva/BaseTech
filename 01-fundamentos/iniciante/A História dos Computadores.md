...
timeline
    ...
    section Mecânica
      1642 : Pascalina
        : Primeira máquina<br>de calcular mecânica
      1837 : Máquina Analítica
        : Primeiro conceito<br>de computador programável
    section Eletromecânico
      1941 : Z3
        : Primeiro computador<br>programável funcional
    section Primeira Geração
      1946 : ENIAC
        : Primeiro computador<br>eletrônico digital
    section Segunda Geração
      1959 : Transistores
        : Computadores menores<br>e mais confiáveis
    section Terceira Geração
      1965 : Circuitos Integrados
        : Surgimento dos chips
    section Quarta Geração
      1971 : Microprocessador
        : Computadores pessoais<br>se tornam possíveis
    section Quinta Geração
      2000s : Inteligência Artificial
        : Computação quântica<br>e aprendizado de máquina
```
...
![Máquina Analítica de Babbage](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Babbage_Difference_Engine.jpg/600px-Babbage_Difference_Engine.jpg)
...
![Ada Lovelace](https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Ada_Lovelace.jpg/500px-Ada_Lovelace.jpg)
...
![ENIAC - Primeiro Computador Eletrônico](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/ENIAC_Penn1.jpg/800px-ENIAC_Penn1.jpg)
